...
import pageObject.nopCommerce.users.UserAddressPO;
import pageObject.nopCommerce.users.UserCustomerInforPO;
import pageObject.nopCommerce.users.UserOrderPO;
import pageObject.nopCommerce.users.UserRewarPointPO;
...
public class BasePage {
    ...
    * */
    ...
    public Boolean isElementDisplayed(WebDriver webDriver, String locator, String... restParameter){
        return getWebElement(webDriver, castParameter(locator,restParameter)).isDisplayed();
    }
...
//        webDriver.switchTo().frame(getWebElement(webDriver, locator));
    ...
    * */
    ...
    public UserRewarPointPO openRewardPointPage(WebDriver driver) {
